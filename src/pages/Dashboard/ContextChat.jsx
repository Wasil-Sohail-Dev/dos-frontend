...
import { sendContextMessage } from "../../store/chat/services";
import PreviewContextChart from "component/Layout/Dashboard/PreviewContextChart";
...
const ContextChat = () => {
  ...
  console.log("messages at line 32", messages)
  ...
  const handleSubmit = async (e, initialMsg = null) => {
    ...
    try {
      await dispatch(sendContextMessage({
  ...
  return (
    ...
    >
      {messages.length === 0 ? (
        <PreviewContextChart message={message} setMessage={setMessage} handleSubmit={handleSubmit} isLoading={isLoading} />
      ) : (
        <>
