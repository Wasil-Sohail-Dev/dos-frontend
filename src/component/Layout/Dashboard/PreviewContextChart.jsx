...
const PreviewContextChart = ({ message, setMessage, handleSubmit, isLoading }) => {

  return (
    <div className="flex flex-col items-center mt-40">
      <h1 className="text-[32px] lg:text-[48px] font-bold mb-4 text-gray-800 leading-[70px] ">Search Query?</h1>
...
export default PreviewContextChart